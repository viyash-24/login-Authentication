...
const onSubmitNewPassword =async(e) =>{
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-br from-transparent '>
      <img onClick={()=>navigate('/')} src={assets.logo} alt='' className='absolute left-5 sm:left-20 top-5 w-28 sm:w-32 cursor-pointer'/>

    {/* enter email id */}
    {!isEmailSent && 
      <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
         <h1 className='text-white tesxt-2xl font-semibold text-center mb-4'>Reset Password</h1>
        <p className='text-indigo-300   text-center mb-6'>Enter the registered email address.</p>
        ...
        <button className='w-full py-2.5 bg-gradient-to-r from-indigo-500 t0-indigo-900 text-white rounded-full mt-3'>Submit</button>
...
{!isOtpSubmited && isEmailSent &&
      <form  onSubmit={onSubmitOtp}className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
        ...
        <h1 className='text-white tesxt-2xl font-semibold text-center mb-4'>Reset password OTP</h1>
    ...
    <form onSubmit={onSubmitNewPassword} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
         <h1 className='text-white tesxt-2xl font-semibold text-center mb-4'>New Password</h1>
